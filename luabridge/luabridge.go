...
import (
	...
	gluamapper "github.com/AzureWrathCyd/gluamapper"
...
func SafeCall(L *lua.LState, funcName string, retRef interface{}, args ...interface{}) (err error) {
	...
	if rKind != reflect.Ptr && rKind != reflect.Invalid {
		err = errors.New("parm retRef must be a pointer")
		return
	}
...
//SafeLoadload lua file by name with protect
...
//SafeLoadload lua str with protect
